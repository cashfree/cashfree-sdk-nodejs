...
Please refer to the [Cashfree Docs](https://docs.cashfree.com/reference) for the complete API reference.
...
- [Create Orders](https://docs.cashfree.com/reference/create-orders)
...
- [Get Link](https://docs.cashfree.com/reference/get-link)
...
- [Get Details](https://docs.cashfree.com/reference/get-details)
...
- [Get Status](https://docs.cashfree.com/reference/get-status)
...
- [Trigger Payment Email](https://docs.cashfree.com/reference/send-payment-email)
...
- [Initiate Refund](https://docs.cashfree.com/reference/initiate-refund)
...
- [Fetch All Refunds](https://docs.cashfree.com/reference/fetch-all-refunds)
...
- [Fetch Single Refund](https://docs.cashfree.com/reference/fetch-single-refund)
...
- [Fetch All Settlements](https://docs.cashfree.com/reference/fetch-all-settlements)
...
- [Fetch Single Settlement](https://docs.cashfree.com/reference/fetch-single-settlement)
